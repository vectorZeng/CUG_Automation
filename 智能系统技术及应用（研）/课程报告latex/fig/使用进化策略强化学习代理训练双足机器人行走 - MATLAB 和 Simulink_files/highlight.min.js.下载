...
!function(){var e=function(){"use strict";return function(e){return{aliases:["ssc"],case_insensitive:!1,keywords:{keyword:[".elseif","case","modecharts","global","mode","definitions","catch","annotations","parameters","end","connect","component","outputs","branches",".else","modechart","modes","elseif","break","der","otherwise","else","transitions","throughs","while","components","domain","let","assert",".end","time","return","inputs","elsewhen","switch","connections","in","import","try","initial","intermediates","persistent","equations","continue","pre","when","events",".if","nodes","if","function","equation","variables","for","entry"]},contains:[{className:"string",variants:[{begin:'"',end:'"'},{begin:/(?<![\w)\]\}\.\'])'/,end:"'",contains:[{begin:"''"}]}]},e.COMMENT("%","$"),{scope:"operator",match:/(?<=[\w\)\]\}\.])'/}]}}}();hljs.registerLanguage("simscape",e)}();